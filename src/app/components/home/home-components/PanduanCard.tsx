...
export function PanduanCardR({ image, head, body }: PanduanCardProps) {
  return (
    <main className="w-auto max-w-[450px] p-7 h-auto bg-gray-1  shadow-shadow-2 flex items-start gap-[28px] rounded-2xl">
      <Image
        src={image}
        alt={head}
...
export function PanduanCardL({ image, head, body }: PanduanCardProps) {
  return (
    <main className="w-auto max-w-[450px] h-auto bg-gray-1 p-7 shadow-shadow-2 flex items-start gap-[28px] rounded-2xl text-right flex-row-reverse">
      <Image
        src={image}
        alt={head}
