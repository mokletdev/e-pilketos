        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-x-7">
              ...
              <div
                className={clsx(
                  "fixed bg-white p-6 transition-all rounded-[48px] top-28 -z-10 flex flex-col gap-[18px] shadow-shadow-2 xl:hidden",
                  modal ? "left-4" : "-left-[100%]",
                )}
              >
              ...
              <>
                {status !== "loading" ? (
                  ...
                  <div className="flex justify-center items-center gap-x-3">
                    ...
                    <Large_Text variant="MEDIUM" className="text-primary-color">
                      Loading...
                    </Large_Text>
                  </div>
                )}
