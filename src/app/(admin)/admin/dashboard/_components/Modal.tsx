...
import { SelectField, TextField } from "@/app/components/general/Input";
import { AddModal } from "@/app/components/general/Modal";
import { Medium_Text } from "@/app/components/general/Text";
import { updateUserById } from "@/utils/database/getServerSession";
...
export default function Modal({
  ...
  data?: userLastLoginPayload | null;
}) {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      const update = await updateUserById(data?.id as string, formData);
      if (!update.error) {
